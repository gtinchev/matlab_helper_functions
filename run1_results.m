...
%MAIN The main function for interpolating and plotting
    ...
    % interpolate
    gps_interpolated_151 = interpolate_measurements(filtered_gps_run1_151);
    gps_interpolated_201 = interpolate_measurements(filtered_gps_run1_201);
    gps_interpolated_251 = interpolate_measurements(filtered_gps_run1_251);
